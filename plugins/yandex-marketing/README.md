...
Cross-service paid-acquisition analysis over structured outputs from Yandex Direct, Metrika, Wordstat and optional Search. Version 1.0.1 is read/analyze/recommend/preview only and contains no Yandex credentials or HTTP clients.
