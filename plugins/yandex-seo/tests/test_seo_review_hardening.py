    ...
    def test_destructive_existing_site_decision_strips_execution_state(self):
        result = seo_topical_architecture.build_topical_architecture(
            ...
            page_decisions=[{
                ...
                "decision": "MERGE",
                "cluster_ids": [],
                "reason_codes": ["SERP_OVERLAP", "WEBMASTER_EXISTING_URL"],
    ...
    def test_supplied_breadcrumbs_must_match_canonical_ancestor_chain(self):
        with self.assertRaises(ValueError):
            seo_topical_architecture.build_topical_architecture(
                ...
                structural_nodes=[
                    {
                        "page_id": "root", "proposed_url": "/", "page_role": "ROOT",
                        "canonical_parent_id": None, "breadcrumbs": [], "cluster_ids": [],
                        "evidence": [], "confidence": "MEDIUM",
                    },
                    {
                        "page_id": "child", "proposed_url": "/child/", "page_role": "SUPPORT",
                        "canonical_parent_id": "root", "breadcrumbs": [], "cluster_ids": [],
        ...
        result = seo_topical_architecture.build_topical_architecture(
            ...
            structural_nodes=[
                ...
                {
                    "page_id": "child", "proposed_url": "/child/", "page_role": "SUPPORT",
                    "canonical_parent_id": "root", "breadcrumbs": ["root"], "cluster_ids": [],
                    "evidence": [], "confidence": "LOW",
                },
            ],
            semantic_edges=[],
