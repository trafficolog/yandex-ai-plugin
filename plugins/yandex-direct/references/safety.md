...
- Any change to environment, OAuth auth principal, service, account/`Client-Login`, target object, method, path, body, budget, bid, strategy, or other bound field invalidates the approval and requires a fresh preview.
