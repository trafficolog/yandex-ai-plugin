...
EXPECTED = {
    "REQ-SKILL-ROUTING", "REQ-SKILL-CONTENT", "REQ-REFERENCE-VOLATILITY",
    "REQ-HELPER-TESTS", "REQ-EVAL-CONTRACT", "REQ-READ-FIRST",
    "REQ-WRITE-PREVIEW", "REQ-EXPLICIT-APPROVAL", "REQ-NO-SECRETS",
    "REQ-CAPABILITY-MATRIX", "REQ-PLUGIN-SEMVER",
    "REQ-NO-UNIVERSAL-THRESHOLDS", "REQ-RUNTIME-PATH-PORTABILITY",
    "REQ-SOURCE-SEMANTICS", "REQ-CROSS-SERVICE-TRANSPORT",
    "REQ-BILINGUAL-DOCS", "REQ-CHANGELOG-PARITY",
