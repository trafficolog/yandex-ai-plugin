...
| Yandex Webmaster | 1 | **available** | 1.0.1 | indexing, diagnostics, queries, sitemaps, recrawl, links, feeds, exports | bundled API helpers; optional MCP/app backend |
| Yandex Wordstat | 1 | **available** | 1.0.1 | demand, frequency, semantics, dynamics, regions, trends | bundled Cloud Wordstat v2 helpers; optional MCP/app backend |
| Yandex Search | 1 | **available** | 1.0.1 | web SERP, batch, rankings, competitors, URL-overlap clustering | bundled Search API v2 helpers; optional MCP/app backend |
...
| Yandex Marketing | X | **available** | 1.0.1 | cross-service paid performance, KPI reconciliation, demand/query intelligence, landing/budget opportunities | pure-data orchestration over Direct + Metrika + Wordstat with optional Search context |
...
- `yandex-marketing`: **available 1.0.1** — Direct + Metrika + Wordstat, with Search as optional context.
