...
| Yandex Webmaster | 1 | **available** | 1.0.2 | indexing, diagnostics, queries, sitemaps, recrawl, links, feeds, exports; hardened PRO export contract | bundled API helpers; optional MCP/app backend |
